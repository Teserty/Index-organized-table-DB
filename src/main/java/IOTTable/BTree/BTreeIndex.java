 ...
 */
package IOTTable.BTree;

import IOTTable.BTree.FreeList.FreeSpace;
import IOTTable.BTree.indexer.IndexQuery;
import IOTTable.BTree.utils.collections.LRUMap;
import IOTTable.BTree.utils.collections.longs.LongHash.BucketEntry;
import IOTTable.BTree.utils.collections.longs.LongHash.Cleaner;
import IOTTable.BTree.utils.collections.longs.PurgeOptObservableLongLRUMap;
import IOTTable.BTree.utils.lang.Primitives;
...
public class BTreeIndex extends BTree {
    ...
    static {
        DATA_CACHE_SIZE = 2048; // 4k * 2048 = 8m
        DATA_CACHE_PURGE_UNIT =16; // 4k * 16 = 64k
    }
    ...
    public BTreeIndex(File file) {
        super(file, DEFAULT_PAGESIZE, DEFAULT_IN_MEMORY_NODES, false);
        final Synchronizer sync = new Synchronizer();
        this.dataCache = new PurgeOptObservableLongLRUMap<DataPage>(DEFAULT_IN_MEMORY_NODES,
                DATA_CACHE_PURGE_UNIT, sync);
        this.numDataCaches = DATA_CACHE_SIZE;
    }
    ...
    public BTreeIndex(File file, int idxPageCaches, boolean duplicateAllowed) {
        this(file, DEFAULT_PAGESIZE, DEFAULT_IN_MEMORY_NODES, DATA_CACHE_SIZE, duplicateAllowed);
    }
    ...
    private final class DataPage implements Comparable<DataPage> {
        ...
        public byte[] remove(int tidx) throws BTreeException {
            ...
            final byte[] tuple = tuples.get(tidx);
            this.dirty = true;
