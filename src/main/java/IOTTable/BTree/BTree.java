...
import IOTTable.BTree.indexer.BasicIndexQuery;
import IOTTable.BTree.indexer.IndexQuery;
import IOTTable.BTree.utils.codec.VariableByteCodec;
...
import IOTTable.BTree.utils.io.FastMultiByteArrayOutputStream;
import IOTTable.BTree.utils.lang.ArrayUtils;
...
public class BTree extends Paged {
    ...
    static {
        DEFAULT_IN_MEMORY_NODES = 4096; // 16m
        BTREE_NODECACHE_PURGE_UNIT = 8; // 32k
    }
